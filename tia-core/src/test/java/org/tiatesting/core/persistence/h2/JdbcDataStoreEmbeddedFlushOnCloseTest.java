...
class JdbcDataStoreEmbeddedFlushOnCloseTest {
    ...
    void trackedLibraryWrittenThenClosedSurvivesReopenByFreshDatastore() {
        ...
        JdbcDataStore second = new JdbcDataStore(new H2Dialect(), new H2ConnectionProvider(H2ConnectionSettings.embedded(tempDir.getAbsolutePath())), BranchSchema.schemaName("master", null));
        try {
