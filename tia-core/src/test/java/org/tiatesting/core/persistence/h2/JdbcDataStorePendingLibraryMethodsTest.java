...
class JdbcDataStorePendingLibraryMethodsTest {
    ...
    void readReturnsEmptyListWhenTableDoesNotExist() {
        ...
        JdbcDataStore freshStore = new JdbcDataStore(new H2Dialect(), new H2ConnectionProvider(H2ConnectionSettings.embedded(tempDir.getAbsolutePath())), BranchSchema.schemaName("fresh", null));
