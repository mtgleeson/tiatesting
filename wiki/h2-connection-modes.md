...
Open `http://localhost:8082`, connect with JDBC URL `jdbc:h2:tcp://localhost:9092/tiadb` and user `sa`, and Tia's tables appear under the current branch's schema (e.g. `tia_main`) after the first run.
