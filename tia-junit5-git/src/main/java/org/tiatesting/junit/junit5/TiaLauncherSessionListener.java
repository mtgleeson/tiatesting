...
public class TiaLauncherSessionListener implements LauncherSessionListener {
     ...
     * Tia Git {@link TiaJunit5GitListener} as a {@link org.junit.platform.launcher.TestExecutionListener}
     ...
     * so the shipped service descriptor inside the tia-junit5-git jar does not
